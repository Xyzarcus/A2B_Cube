...
and its licensors.
******************************************************************************
* @file: adi_a2b_audiorouting.h
* @brief: This file contains macros and structure definitions used for audio 
*         routing in SHARC      
* @version: $Revision$
* @date: $Date$
* BCF Version - 1.0.0
...
*****************************************************************************/
#ifndef _ADI_A2B_AUDIOROUTER_H
#define _ADI_A2B_AUDIOROUTER_H
