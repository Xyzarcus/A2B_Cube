...
#define A2B_CONF_DEFAULT_TRACE_LVL		(A2B_TRC_DOM_ALL | A2B_TRC_LVL_TRACE3 | A2B_TRC_LVL_TRACE2 | A2B_TRC_LVL_TRACE1 | A2B_TRC_LVL_DEBUG | A2B_TRC_LVL_INFO | A2B_TRC_LVL_DEFAULT)
