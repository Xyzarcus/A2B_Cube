...
)
{
	...
	if(pSlvNode->nodeDescr.oCustomNodeIdSettings.bCustomNodeIdAuth == ENABLED)
	{
		if(pSlvCfg->sCustomNodeAuthSettings.nReadFrm == A2B_READ_FROM_MEM)
		{
			...
			pSlvNode->nodeDescr.oCustomNodeIdSettings.has_bReadFrmMemory = true;
			pSlvNode->nodeDescr.oCustomNodeIdSettings.has_nDeviceAddr = true;
			pSlvNode->nodeDescr.oCustomNodeIdSettings.has_nReadMemAddrWidth = true;
			pSlvNode->nodeDescr.oCustomNodeIdSettings.has_nReadMemAddr = true;
		}
		else
		{
		...
		if(pSlvCfg->sCustomNodeAuthSettings.nReadFrm == A2B_READ_FROM_GPIO)
		{
			...
			pSlvNode->nodeDescr.oCustomNodeIdSettings.has_bReadGpioPins = true;
		}
		else
		{
		...
		if(pSlvCfg->sCustomNodeAuthSettings.nReadFrm == A2B_READ_FROM_COMM_CH)
		{
			...
			pSlvNode->nodeDescr.oCustomNodeIdSettings.has_bReadFrmCommCh = true;
		...
		pSlvNode->nodeDescr.oCustomNodeIdSettings.has_nNodeId = true;
		pSlvNode->nodeDescr.oCustomNodeIdSettings.has_nNodeIdLength = true;
		pSlvNode->nodeDescr.oCustomNodeIdSettings.has_nTimeOut = true;

		pSlvNode->nodeDescr.oCustomNodeIdSettings.nDeviceAddr		= pSlvCfg->sCustomNodeAuthSettings.nDeviceAddr;
		a2b_memcpy(&pSlvNode->nodeDescr.oCustomNodeIdSettings.nNodeId[0], &pSlvCfg->sCustomNodeAuthSettings.nNodeId[0], ADI_A2B_MAX_CUST_NODE_ID_LEN);
