...
A2B_CHANNEL_UNUSED, /* DOWNSTREAM CH 2 */
A2B_CHANNEL_UNUSED, /* DOWNSTREAM CH 3 */
A2B_CHANNEL_UNUSED, /* DOWNSTREAM CH 4 */
A2B_CHANNEL_UNUSED, /* DOWNSTREAM CH 5 */
A2B_CHANNEL_UNUSED, /* DOWNSTREAM CH 6 */
A2B_CHANNEL_UNUSED, /* DOWNSTREAM CH 7 */
